...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    int number = ran.nextInt(999999);  // Random employee ID
    
    JTextField tfname, tffname, tfaddress, tfphone, tfaadhar, tfemail, tfsalary, tfdesignation;
    JDateChooser dcdob;
    JComboBox<String> cbeducation;  // Type safety for JComboBox
    JLabel lblempId;
    JButton add, back;
    ...
    AddEmployee() {
        ...
        cbeducation = new JComboBox<>(courses);  // Use String array for JComboBox
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            if (name.isEmpty() || fname.isEmpty() || dob.isEmpty() || salary.isEmpty() || 
                address.isEmpty() || phone.isEmpty() || email.isEmpty() || aadhar.isEmpty() || 
                designation.isEmpty()) {
